...
INSERT INTO collections (id, name, description) VALUES
    (1, 'Home collection', 'Discover the artistry of our handmade vase collection. Embracing diverse styles and textures, our vases are designed to add a touch of elegance and warmth to your living spaces. Explore the timeless beauty of handcrafted pottery as you bring a unique blend of art and functionality into your home with our exquisite vase collection.'),
    (2, 'Dining collection', 'Discover the artistry of our handmade Dining Collection. Each piece in our Handmade Collection is a testament to the passion and skill of our artisans, crafted with meticulous attention to detail. ');

-- Inserting products
INSERT INTO products (id, images, category_id, catalog_price, discount_catalog_price, name, description, care_guide) VALUES
   (1,  '{}', 4, 100.00, null, 'Black night Vase', 'Description 1', 'Care Guide 1'),
...
INSERT INTO products_collections (collections_id, product_id) VALUES
    (1, 4),
    (1, 5),
    (1, 12),
    (1, 13),
...
INSERT INTO properties (id, material_id, color_id, default_price, discount_price, quantity, sold, product_id, dimensions) VALUES
   (1, 2, 5, 100.00, null, 10, 0, 1, '10x10x10'),
